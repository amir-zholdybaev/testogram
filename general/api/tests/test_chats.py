...
class ChatTestCase(APITestCase):
    ...
    def test_get_messages_from_someone_elses_chat(self):
        user_1 = UserFactory()
        user_2 = UserFactory()
        chat = ChatFactory(user_1=user_1, user_2=user_2)

        message_1 = MessageFactory(author=user_1, chat=chat)
        message_2 = MessageFactory(author=user_2, chat=chat)
